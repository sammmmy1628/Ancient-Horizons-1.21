...
public class ModArmourMaterials {
    ...
    public static final Holder<ArmorMaterial> ALUMINIUM_ARMOR_MATERIAL = register("aluminium",
            ...
            }), 9, 0f, 0.0f, () -> ModItems.ALUMINIUM_INGOT.get());

    public static final Holder<ArmorMaterial> BRONZE_ARMOUR_MATERIAL = register("bronze",
            Util.make(new EnumMap<>(ArmorItem.Type.class), attribute -> {
            ...
            }), 11, 0f, 0.0f, () -> ModItems.BRONZE_ALLOY.get());

    public static final Holder<ArmorMaterial> SILVER_ARMOUR_MATERIAL = register("silver",
            Util.make(new EnumMap<>(ArmorItem.Type.class), attribute -> {
            ...
            }), 11, 0.1f, 0.2f, () -> ModItems.SILVER_INGOT.get());
